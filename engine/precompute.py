...
ARCHETYPES = {
    'steady': {
        ...
        'risk': 'Low-Medium',
        'color': '#4A8FE0',
        'description': 'Large and flexi cap dominant. Lower volatility. Includes one overseas equity diversifier for genuine cross-market exposure when Indian markets are tepid.',
        'devils': [
            'Large cap dominance means this bouquet may lag mid/small cap options by 4-6% in strong bull cycles',
            'International FOF slot (18%) is taxed as a DEBT fund — income slab rate applies, not 12.5% LTCG',
            'International allocation adds currency risk not captured in historical INR returns',
            'Historical 14-16% CAGR does not guarantee future returns — the next 7 years may deliver more or less',
            'Funds selected from scored universe — composition will evolve as scores update with new NAV data',
        ],
        'methodology': [
            'Large and flexi cap dominant — selected from 225+ scored funds for lower-volatility profile',
            '18% international diversifier slot (overseas equity FOF) — minimises average correlation with India equity',
            'All funds direct plans only — zero trail commission conflict',
            'Required: at least one Large Cap and one Flexi/Multi/Large-&-Mid Cap — ensures stability floor',
    ...
    'balanced': {
        ...
        'risk': 'Medium',
        'color': '#27AE78',
        'description': 'Diversified across mid, small and flexi cap with an international diversifier slot. Most commonly appropriate for 7+ year horizons.',
        'devils': [
            ...
            'International FOF slot (13%) is taxed as a DEBT fund — income slab rate applies, not 12.5% LTCG',
            'Small cap allocation may face liquidity constraints during industry-wide panic redemptions',
            'High correlation between India small and mid cap — significant portion of bouquet moves in tandem in crashes',
        ],
        'methodology': [
            'Funds selected across 5 distinct SEBI categories from 225+ scored universe — genuine diversification',
            '13% international diversifier slot (overseas equity FOF) — chosen to minimise correlation with India equity',
    ...
    'aggressive': {
        ...
        'risk': 'Medium-High',
        'color': '#F0A500',
        'description': 'Mid and small cap dominant. Pure India equity — no international slot. Higher return potential with higher volatility. Requires genuine long-term conviction.',
        'devils': [
            '70%+ mid and small cap exposure — this bouquet can fall 50-65% in a severe bear market',
            'Multiple funds in mid or small cap — category concentration exists despite different fund houses',
            ...
            'Mid and small cap valuations elevated relative to historical averages as of 2026',
            'Funds selected dynamically — composition evolves as the 225+ fund scored universe updates',
        ],
        'methodology': [
            'Mid and small cap dominant — selected from full 225+ scored universe for maximum return potential',
            'Required: at least one Mid Cap and one Small Cap fund — captures both growth segments',
            'No two funds from same AMC — different AMC philosophy and risk management',
            'All funds direct plans only — pure India equity, no international slot',
    ...
    'conviction': {
        ...
        'risk': 'High',
        'color': '#E05555',
        'description': 'Concentrated small cap dominant. Pure India equity conviction play. Highest historical return potential. Highest crash risk. Only for investors who have stayed invested through a 40%+ portfolio fall.',
        'devils': [
            ...
            '40%+ in small cap means significant redemption difficulty during market stress',
            'Historical high CAGR partly driven by exceptional post-COVID small cap recovery — may not repeat',
            'Confidence score reflects rolling period win rate — not a guarantee',
            'Suitable ONLY for investors who have previously stayed invested through a 40%+ fall',
        ],
        'methodology': [
            'High conviction construction from 225+ scored universe — maximum long-term return potential',
            'Small cap dominant weighting — highest return/risk per the scoring engine',
            'No two funds from same AMC — reduces single-house concentration',
            'Required: at least one Small Cap and one Mid Cap — concentration with some spread',
            'All funds direct plans only — zero commission conflict',
